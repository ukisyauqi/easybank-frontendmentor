...
import NavbarMenuBtn from "./components/NavbarMenuBtn";
import RequestBtn from "./components/RequestBtn";
import logo from "./images/logo.svg";
import bgIntroDesktop from "./images/bg-intro-desktop.svg";
import imgMockups from "./images/image-mockups.png";
import icOnline from "./images/icon-online.svg";
import icBudgeting from "./images/icon-budgeting.svg";
import icOnboarding from "./images/icon-onboarding.svg";
import icApi from "./images/icon-api.svg";
import CardArticle from "./components/CardArticle";

import imgCurency from "./images/image-currency.jpg";
...
export default function App() {
  ...
  const currentScrollPos = useRef();

  useEffect(() => {
    window.addEventListener("scroll", (e) => {
      currentScrollPos.current = window.pageYOffset;
      if (currentScrollPos.current < 50) return;
      if (prevScrollPos.current > currentScrollPos.current) {
  ...
  return (
    <Box overflowX="hidden" minH="100vh">
      ...
      <Box
        ...
        transition="0.2s"
      >
        <Center float="left" w="33vw" h="full">
          <Image src={logo} alt="company logo" h={5} />
        </Center>
        <Center float="left" w="34vw" h="full">
          <NavbarMenuBtn text="Home" />
          <NavbarMenuBtn text="About" />
          <NavbarMenuBtn text="Contact" />
          <NavbarMenuBtn text="Blog" />
          <NavbarMenuBtn text="Careers" />
        </Center>
        <Center float="left" w="33vw" h="full">
          <RequestBtn />
        </Center>
      ...
      {/* Body */}
      <Box pt={16} position="relative" bg="#FAFAFA">
        {/* gambar hp */}
        <Image
          src={imgMockups}
          position="absolute"
        ...
        <Box h="90vh" position="relative" overflow="hidden">
          ...
          <Center w="50%" h="full">
            <Box>
              <Text fontSize="5xl" w="400px">
                Next generation digital banking
              </Text>
              <Text mt="20px" w="400px" color="gray.400">
        ...
        {/* #2 section */}
        <Center bg="#F4F5F7" h="90vh">
          <Box w="1000px" h="80%">
            <Text fontSize="4xl">Why choose Easybank?</Text>
            ...
            <SimpleGrid columns={4} mt={16} spacing={6}>
              <Box h="100px">
                <Image src={icOnline} />
        ...
        <Center h="90vh">
          <Box w="1000px">
            <Text fontSize="4xl">Latest Articles</Text>
        ...
        <Center bg="#2D314E">
          <Box w="1000px" h="100px" my="40px">
            ...
            >
              ...
              <Flex justifyContent="space-between" w="140px">
                {/* icon facebook */}
                <Box color="white" _hover={{ color: "teal.300" }}>
                  <svg
